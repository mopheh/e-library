...
function BookWrap() {
  ...
  return (
    <div className="flex w-full gap-4 px-2">
      <div className="bg-white dark:bg-gray-950 rounded-lg w-1/2 p-3 h-[400px] relative overflow-hidden font-poppins">
        <h3 className="text-base font-semibold mb-4 font-open-sans">
          Reading Activity (Last 7 Days)
        </h3>
        <Charts />
      </div>
      <div className="bg-white dark:bg-gray-950 rounded-lg w-1/2 p-3 h-[400px] relative overflow-hidden">
        ...
        <div
          className="w-full h-fit absolute left-0 bottom-[0]
        "
        >
          <Image

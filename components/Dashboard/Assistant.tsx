  ...
  return (
    <div className="w-full h-full flex flex-col bg-[#ece5dd] dark:bg-[#0b141a]">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2 text-sm">
        ...
        {loading && (
          <div className="flex justify-start">
            <div className="bg-white rounded-lg rounded-bl-none px-3 py-2 shadow text-zinc-500 animate-pulse">
              typing...
            </div>
          </div>
        )}
      ...
      <form
        ...
        className="flex items-center gap-2 bg-white px-3 py-2 border-t dark:bg-zinc-800  dark:border-zinc-700"
      >
        <input
          type="text"
          value={input}
          onChange={(e) => setInput(e.target.value)}
          className="flex-1 px-4 py-2 rounded-full bg-zinc-100 focus:outline-none dark:bg-zinc-700 dark:text-white text-sm"

...
function BookWrap() {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full gap-4 sm:px-2">
      {/* Charts Section */}
      <div className="bg-white dark:bg-zinc-950 rounded-lg w-full lg:w-1/2 p-3 h-[400px] relative overflow-hidden font-poppins">
      ...
      <div className="bg-white dark:bg-zinc-950 rounded-lg w-full lg:w-1/2 p-3 h-[400px] relative overflow-hidden">
        <div className="flex justify-between items-center mb-3">
          <h3 className="font-semibold font-open-sans">Recently Viewed</h3>
          <button className="bg-zinc-50 dark:bg-zinc-800 text-xs cursor-pointer text-green-500 px-3 py-2 text-open-sans font-poppins rounded-lg">
            View All
          </button>
        </div>
          ...
          {books.length !== 0 ? (
            ...
            <>
              ...
              <div className="font-poppins">
                <h4 className="text-center mb-1 font-open-sans font-semibold text-zinc-800 dark:text-zinc-100">
                  No Books Viewed
                </h4>
